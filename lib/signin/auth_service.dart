...
class AuthService {
  ...
  Future<bool> login() async {
    ...
    String _result = await globals.Utility.postData(
      globals.domain + "userManagement/", mapData);
    String _avatar, _id, _token;
    try {
      Map decoded = json.decode(_result);

      if (decoded['detail'] != null) {
        globals.errorMessage = decoded['detail'].toString();
        return false;
      }
